    ...
    try {
      if (isFollowing) {
        await supabase
          .from("user_follows")
          .delete()
          .match({ follower_id: user.id, following_id: user.id });
  ...
  const badges = [
    {
      ...
      name: "Explorer",
      emoji: "🌍",
      desc: "Kunjungi 5 negara",
      unlocked: (countriesVisited || 0) >= 5,
    },
    {
      id: 2,
      name: "Foodie",
      emoji: "🍜",
      desc: "10 trip kuliner",
      unlocked: stats.trips >= 10,
    },
    {
      id: 3,
      name: "Social Butterfly",
      emoji: "🦋",
      desc: "10 collaborator",
      unlocked: false,
    },
    {
      id: 4,
    ...
    },
    {
      ...
      name: "Globe Trotter",
      emoji: "🌏",
      desc: "Kunjungi 10 negara",
      unlocked: (countriesVisited || 0) >= 10,
    },
    {
      id: 6,
      name: "Legend",
      emoji: "👑",
      desc: "50 trip selesai",
      unlocked: false,
    },
  ];
          ...
          >
            ...
            {!isOwnProfile && (
              <div className="flex items-center justify-center gap-3 mt-6">
                ...
                <Button
                  size="sm"
                  className="bg-white/20 backdrop-blur-md border border-white/30 hover:bg-white/35 text-white"
                >
            ...
            <div className="glass-card p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="text-center p-4 rounded-xl bg-gradient-to-br from-[var(--aurora-start)]/10 to-[var(--aurora-end)]/10"
                  >
              ...
              {loading ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>
                    Belum ada trip.{" "}
                    <button
                      className="text-[var(--aurora-start)]"
                ...
                tripHistory.map((trip) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <Badge
                        variant={
                          trip.status === "completed" ? "aurora" : "secondary"
                        }
                      >
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground">
                  Trip yang kamu simpan akan muncul di sini
                </p>
                <Button
                  variant="gradient"
                  size="sm"
                    ...
                    {trip.tags && trip.tags.length > 0 && (
                      <div className="flex flex-wrap gap-1">
                        {trip.tags.slice(0, 3).map((tag) => (
                          <span
                            key={tag}
                            className="text-xs px-2 py-0.5 rounded-full bg-[var(--aurora-start)]/10 text-[var(--aurora-start)]"
                          >
                            {tag}
                          </span>
                        ))}
